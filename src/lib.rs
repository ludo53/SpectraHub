...
#[derive(Debug)]
pub struct SpectraHubProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SpectraHubProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SpectraHub processing");
    
    let mut processor = SpectraHubProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SpectraHubProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SpectraHubProcessor::new(false);
